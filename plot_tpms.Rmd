...
xy_counts <- read.delim('/lab/solexa_page/hannah/supp_info/tables/fib_merged_counts_by_sample.txt')
xaxi_counts <- read.delim("/lab/solexa_page/hannah/supp_info/tables/Fib_m_lcl_ar.txt"
)
...
xy_counts <- read.delim('/lab/solexa_page/hannah/supp_info/tables/LCL_merged_counts_by_sample.txt')
